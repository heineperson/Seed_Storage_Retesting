...
# Summarize Germination Test Initial Counts for those with initial values in the init columsn
germTestInitLong <- melt(germTest[!is.na(Rep1Init)],
                     id.vars=c("PK_ID","SeedAccessionNumber","NumberSeedsPulled",""),
...
# Summarize Germination Test Initial Counts & Old Germinants from the old tests
germTestInitOld <- germTest[,.("PK_ID","SeedAccessionNumber","")]
