...
# Priorities for Fresh Testing Summer 2018

I think the fastest way to get good retesting is to prioritize fresh testing of **rare** accessions that were frozen in 2018 that are due for retesting in 2018. Ideally, we can start 
...
write.csv(priorityTableFresh,paste0("priorityTableFresh-", currentDate,".csv"))
